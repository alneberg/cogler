...
def main(args):
    ...
    # Load markers
    markers_per_phyla = pd.read_table(args.marker_file, sep='\t')
...
if __name__ == "__main__":
   ...
   parser.add_argument('--min_genera', default=0,
           help=('The minimum number of generas needed to be '
